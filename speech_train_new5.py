...
#dic.append("999")
dic.append("B")
filepath="/home/yang/speech/doc/trans/pingyin2.txt"
file = open(filepath) 
filename=[]
file_and_id={}
max_len=0
...
logits=tf.reshape(logits,[1,36,category_num])
...
for c in range(100000):
  ...
  #print("name:",name)
         ...
         _,acc2,loss2,result=sess.run([train,acc,loss,merged] ,feed_dict={x: mf,y_label:yl})
         ...
         #print(y_out)
         #y_out2 = sess.run(decoded[0], feed_dict={x: mf,y_label:yl})
         #print(y_out2)
         #print(yl)
         
         ummary_waiter.add_summary(result,i)
